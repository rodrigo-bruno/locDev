 ...
 * 
 */
public class PinsWindow extends JFrame {
	 ...
	 */
	private static PinsWindow instance = null;
	...
	private void setupWindow() {
		...
		this.btGenerateTable = new JButton("Generate Pins Table");
		...
		this.btGenerateTable.addActionListener(new GeneratePinsTableHandler());
		this.btClose.addActionListener(new ClosePinsHandler());
	 ...
	 */
	public static PinsWindow Instance() {
		if (instance == null) {
			instance = new PinsWindow();
		}
		return instance;
	}
